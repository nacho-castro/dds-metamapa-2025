package ar.utn.ba.ddsi.frontend.services.internal;

import ar.utn.ba.ddsi.frontend.dto.input.AuthResponseDTO;
import ar.utn.ba.ddsi.frontend.dto.input.RefreshTokenDTO;
import ar.utn.ba.ddsi.frontend.exceptions.NotFoundException;
...
public class WebApiCallerService {
  ...
  public WebApiCallerService(@Value("${auth.api.url}") String authServiceUrl) {
